...
function Home() {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        ...
        // Ensure res.data.data is an array and not undefined
  ...
  const getEmbed = (url) => {
    // Match the YouTube URL using regex for different formats
            ...
            <div className="mt-4">
              ...
              {visibleVideos[index] && (
                <div className="mt-4 space-y-4">
                  {course.videos && Array.isArray(course.videos) && course.videos.length > 0 ? (
